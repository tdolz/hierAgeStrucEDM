...
#emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empE5.csv", header=T) #maxE = 5 unlogged numbers at age version
#emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empE5.csv", header=T) #maxE = 5 unlogged numbers at age version E=9
#emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empLOG.csv", header=T)## LOG SCALE VERSION E=5 for SB, E=6 for KRFC, biomass at age for sb
#emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empE10_biom.csv", header=T)
#emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empE9_nobiom.csv", header=T)
emp <-read.csv("modelcomparison_outputs/mixedage_fitstats_empE9_Logbiom.csv", header=T)

emp["Hierarchal"]<-"Hierarchical"

#read in simulated data - all are logged
mixsim <-read.csv("modelcomparison_outputs/modelcomparison_simulation_out.csv", header=T)
...
ggsave("figures/MixedAge1.png", width=4, height=4, dpi=300)
...
ggsave("figures/MixedAge2.png", width=4, height=4, dpi=300)
...
ggsave("figures/MixedAge3.png", width=4, height=4, dpi=300)
...
ggsave("figures/MixedAgeBottom.png", width=10, height=4, dpi=300)
...
ggsave("supplementary_figs/tinyviolinsI.png",width = 15, height = 4,dpi=300)
#dev.off()
...
ggsave("supplementary_figs/tinyviolinsII.png",width = 15, height = 4,dpi=300)
#dev.off()
...
ggsave("supplementary_figs/tinyviolinsIII.png",width = 15, height = 4,dpi=300)
#dev.off()
...
ggsave("supplementary_figs/tinyviolinsKRFC.png",width = 15, height = 4,dpi=300)
#dev.off()
...
ggsave("supplementary_figs/tinyviolinsSB.png",width = 15, height = 4,dpi=300)
#dev.off()
