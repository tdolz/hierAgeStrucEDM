...
#write.csv(SB_fitstats, file="empirical_data/SB_fitstatsE5.csv")
#write.csv(SB_fitstats, file="empirical_data/SB_fitstatsE5LOG.csv")
```
...
#ggsave("figures/SBfitoverdataE5allAgg.png")
#ggsave("figures/SBfitoverdataE5allAggLOG.png")
#dev.off()
...
#Individual age GP for SB
SB_ages <-indv_age(pivSB, E=10)%>%mutate(model="SB_indvAge")
#mixed age GP for SB
...
for (i in 1:nrow(var_pairs)) {
 try({
  fitKRFC <-fitGP(data = KRFC.esc, y = "value", pop="age_class",scaling = "local", E=var_pairs[i,1], tau=var_pairs[i,2], predictmethod = "loo")
...
KRFCETdf %>%
 ...
 theme(axis.text.x = element_text(size=12),
       ...
       panel.grid.major = element_blank(), 
       panel.grid.minor = element_blank())
ggsave("supplementary_figs/r2ETKRFC10.png")
dev.off()
...
ggsave("supplementary_figs/RMSE_ETKRFC10.png")
...
#write.csv(KRFC_fitstats, file="empirical_data/KRFC_fitstatsE6LOG.csv")
```
...
#ggsave("figures/KRFCfitoverdataE5allLOG.png")
#dev.off()
```
...
```{r}
fitstats <-bind_rows(fitstats_KRFCHier,fitstats_SBHier,fitstats_KRFCIndvAge,fitstats_SBIndvAge,fitstats_KRFCMixed,fitstats_SBMixed)%>%select(-`age class`)
...
#write.csv(fitstats,"modelcomparison_outputs/mixedage_fitstats_empE10_biom.csv")
#write.csv(fitstats,"modelcomparison_outputs/mixedage_fitstats_empE9_nobiom.csv")
write.csv(fitstats,"modelcomparison_outputs/mixedage_fitstats_empE9_Logbiom.csv")
```
